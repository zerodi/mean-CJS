(->
  ...
  describe "MEAN controllers", ->
    describe "ArticlesController", ->
      ...
      beforeEach inject(($controller, $rootScope, _$location_, _$routeParams_, _$httpBackend_) ->
        scope = $rootScope.$new()
      ...
      it "$scope.findOne() should create an array with one article object fetched " + "from XHR using a articleId URL parameter", ->
      ...
      it "$scope.update() should update a valid article", inject((Articles) ->
      ...
      it "$scope.remove() should send a DELETE request with a valid articleId" + "and remove the article from the scope", inject((Articles) ->

        # fixture rideshare
        article = new Articles(_id: "525a8422f6d0f87f0e407a33")
